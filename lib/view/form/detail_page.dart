      ...
      body:CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace:
              FlexibleSpaceBar(
                title: Text("Form Bilgisi",style: TitleTextStyle(),),
              ),
            ),
          SliverList(
...
Widget buildInput(int index,BuildContext context,
...
InputDecoration buildInputDecoration(String text,IconData Icon1) {
  return InputDecoration(
    ...
    errorBorder:  OutlineInputBorder(
      borderSide: BorderSide(width:Dimensions.width20 , color: Colors.redAccent),
    ),
  );
}
}
